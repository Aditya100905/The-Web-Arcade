...
//     const baseStyle = "w-20 h-20 flex items-center justify-center text-4xl font-bold border-4 transition-all duration-200 ease-in-out";
...
//     switch (value) {
//       case 0:
//         return `${baseStyle} bg-gradient-to-br from-amber-200 to-amber-300 border-amber-700 shadow-inner ${animationClass}`;
//       case 2:
//         return `${baseStyle} bg-gradient-to-br from-amber-100 to-amber-200 text-gray-700 border-amber-700 shadow-lg ${animationClass}`;
//       case 4:
//         return `${baseStyle} bg-gradient-to-br from-amber-200 to-amber-300 text-gray-700 border-amber-700 shadow-lg ${animationClass}`;
//       case 8:
//         return `${baseStyle} bg-gradient-to-br from-orange-400 to-orange-500 text-white border-amber-700 shadow-lg shadow-orange-500/30 ${animationClass}`;
//       case 16:
//         return `${baseStyle} bg-gradient-to-br from-orange-500 to-orange-600 text-white border-amber-700 shadow-lg shadow-orange-600/30 ${animationClass}`;
//       case 32:
//         return `${baseStyle} bg-gradient-to-br from-orange-600 to-orange-700 text-white border-amber-700 shadow-lg shadow-orange-700/30 ${animationClass}`;
//       case 64:
//         return `${baseStyle} bg-gradient-to-br from-red-500 to-red-600 text-white border-amber-700 shadow-lg shadow-red-600/30 ${animationClass}`;
//       case 128:
//         return `${baseStyle} bg-gradient-to-br from-yellow-400 to-yellow-500 text-white border-amber-700 shadow-lg shadow-yellow-500/40 ${animationClass}`;
//       case 256:
//         return `${baseStyle} bg-gradient-to-br from-yellow-500 to-yellow-600 text-white border-amber-700 shadow-lg shadow-yellow-600/40 ${animationClass}`;
//       case 512:
//         return `${baseStyle} bg-gradient-to-br from-yellow-600 to-yellow-700 text-white border-amber-700 shadow-lg shadow-yellow-700/40 ${animationClass}`;
//       case 1024:
//         return `${baseStyle} bg-gradient-to-br from-yellow-500 to-yellow-600 text-white border-amber-700 text-3xl shadow-xl shadow-yellow-600/50 ${animationClass}`;
//       case 2048:
//         return `${baseStyle} bg-gradient-to-br from-yellow-400 to-yellow-500 text-white border-amber-700 text-3xl shadow-xl shadow-yellow-500/60 animate-pulse ${animationClass}`;
//       case 4096:
//         return `${baseStyle} bg-gradient-to-br from-red-500 to-red-600 text-white border-amber-700 text-3xl shadow-xl shadow-red-600/50 ${animationClass}`;
//       case 8192:
//         return `${baseStyle} bg-gradient-to-br from-red-600 to-red-700 text-white border-amber-700 text-2xl shadow-xl shadow-red-700/50 ${animationClass}`;
//       default:
//         return `${baseStyle} bg-gradient-to-br from-red-600 to-red-800 text-white border-amber-700 text-xl shadow-xl shadow-red-800/50 ${animationClass}`;
//     }
//   };

//   return (
//     <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 text-white flex justify-center items-center px-4 relative overflow-hidden">
...
//       <div className="flex flex-col items-center font-sans w-full max-w-xl space-y-8 py-8 relative z-10">
//         {/* Title */}
//         <div className="text-center mb-4">
//           <h1 className="text-6xl font-black bg-gradient-to-r from-amber-400 via-yellow-500 to-orange-500 bg-clip-text text-transparent drop-shadow-2xl animate-pulse">
//             2048
//           </h1>
...
//           <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl px-6 py-4 shadow-2xl border border-slate-700/50 backdrop-blur-sm">
//             <div className="text-sm text-amber-400 font-semibold tracking-wider uppercase">Score</div>
//             <div className="text-3xl font-black text-white bg-gradient-to-r from-white to-amber-100 bg-clip-text">{score.toLocaleString()}</div>
//           </div>
//           <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl px-6 py-4 shadow-2xl border border-slate-700/50 backdrop-blur-sm">
//             <div className="text-sm text-emerald-400 font-semibold tracking-wider uppercase">Best</div>
//             <div className="text-3xl font-black text-white bg-gradient-to-r from-white to-emerald-100 bg-clip-text">{highScore.toLocaleString()}</div>
//           </div>
//         </div>

//         {/* Game Board */}
//         <div
//           className="p-4 grid grid-cols-4 gap-4 mx-auto rounded-2xl shadow-2xl backdrop-blur-sm border border-slate-600/30"
//           style={{
