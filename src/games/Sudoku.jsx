...
//     let classes = 'w-14 h-14 flex items-center justify-center text-xl font-bold cursor-pointer transition-all duration-300 select-none ';
    
//     // Original puzzle cells (read-only)
//     if (gameState.originalPuzzle[row][col] !== 0) {
//       classes += 'bg-gradient-to-br from-slate-700/80 via-slate-800/90 to-slate-900 text-emerald-300 shadow-inner ';
//     } else {
//       classes += 'bg-gradient-to-br from-slate-800/60 via-slate-900/80 to-black/90 text-white hover:from-emerald-900/30 hover:via-teal-900/30 hover:to-cyan-900/30 transform hover:scale-105 shadow-lg ';
//     }
    
//     // Selected cell with glowing effect
//     if (gameState.selectedCell && gameState.selectedCell[0] === row && gameState.selectedCell[1] === col) {
//       classes += 'ring-3 ring-emerald-400 shadow-emerald-400/50 shadow-xl bg-gradient-to-br from-emerald-800/40 via-teal-800/40 to-cyan-800/40 scale-110 z-10 relative ';
//     }
    
//     // Error cells with pulsing effect
//     if (gameState.errors[row][col]) {
//       classes += 'text-red-300 bg-gradient-to-br from-red-900/50 via-red-800/60 to-red-700/50 ring-2 ring-red-400/50 animate-pulse ';
//     }
    
//     // Enhanced borders for 3x3 boxes
//     const borderClasses = [];
//     if (row % 3 === 0) borderClasses.push('border-t-4 border-t-emerald-400');
//     if (col % 3 === 0) borderClasses.push('border-l-4 border-l-emerald-400');
//     if (row === 8) borderClasses.push('border-b-4 border-b-emerald-400');
//     if (col === 8) borderClasses.push('border-r-4 border-r-emerald-400');
    
//     // Regular borders
//     if (row % 3 !== 0 && row !== 8) borderClasses.push('border-b border-b-slate-600');
//     if (col % 3 !== 0 && col !== 8) borderClasses.push('border-r border-r-slate-600');
...
//     return `px-6 py-3 font-bold text-lg rounded-xl transition-all duration-300 transform ${
//       isActive 
//         ? 'bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-600 text-white shadow-xl shadow-emerald-500/30 scale-105' 
//         : 'bg-gradient-to-r from-slate-700 via-slate-800 to-slate-900 text-emerald-300 hover:from-emerald-900/50 hover:via-teal-900/50 hover:to-cyan-900/50 hover:text-white hover:scale-105 shadow-lg'
//     }`;
//   };
...
//           <div className="mb-6">
//             <h1 className="text-6xl font-black mb-4 bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-2xl">
//               SUDOKU
//             </h1>
//             <p className="text-xl text-emerald-300/80 font-light tracking-wide">Master the Ultimate Number Challenge</p>
//           </div>
          
//           {/* Enhanced Timer Display */}
//           <div className="flex justify-center items-center gap-12 mb-8">
//             <div className="bg-gradient-to-br from-slate-800/80 via-slate-900/90 to-black/80 p-6 rounded-2xl shadow-2xl border border-emerald-500/30">
//               <div className="text-sm text-emerald-400 mb-2 font-semibold tracking-wider uppercase">Current Time</div>
//               <div className="text-4xl font-mono font-bold bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">
//                 {formatTime(timer)}
//               </div>
//             </div>
            
//             {minTime > 0 && (
//               <div className="bg-gradient-to-br from-slate-800/80 via-slate-900/90 to-black/80 p-6 rounded-2xl shadow-2xl border border-yellow-500/30">
//                 <div className="text-sm text-yellow-400 mb-2 font-semibold tracking-wider uppercase">Best Time</div>
//                 <div className="text-4xl font-mono font-bold bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent">
//                   {formatTime(minTime)}
//                 </div>
//               </div>
//             )}
...
//           <div className="bg-gradient-to-br from-slate-800/50 via-slate-900/60 to-black/50 p-6 rounded-2xl shadow-2xl border border-emerald-500/20">
//             <div className="text-center mb-4">
//               <h3 className="text-lg font-semibold text-emerald-400 tracking-wide">Select Difficulty</h3>
//             </div>
...
//         {/* Enhanced Game Board */}
//         <div className="flex justify-center mb-10">
//           <div className="bg-gradient-to-br from-slate-900/80 via-black/90 to-slate-900/80 p-8 rounded-3xl shadow-2xl border-2 border-emerald-500/30">
//             <div className="grid grid-cols-9 gap-1 bg-gradient-to-br from-emerald-500/20 via-teal-500/20 to-cyan-500/20 p-4 rounded-2xl shadow-inner">
//               {gameState.currentPuzzle.map((row, rowIndex) =>
...
//           <div className="bg-gradient-to-br from-slate-800/50 via-slate-900/60 to-black/50 p-6 rounded-2xl shadow-2xl border border-emerald-500/20">
//             <div className="text-center mb-4">
//               <h3 className="text-lg font-semibold text-emerald-400 tracking-wide">Number Input</h3>
//             </div>
...
//                   className="w-14 h-14 bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 hover:from-emerald-800/50 hover:via-teal-800/50 hover:to-cyan-800/50 border border-emerald-500/30 rounded-xl text-xl font-bold transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-emerald-400/20 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
...
//                 className="col-span-1 bg-gradient-to-br from-red-700 via-red-800 to-red-900 hover:from-red-600 hover:via-red-700 hover:to-red-800 border border-red-500/50 rounded-xl text-sm font-bold transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-red-400/20 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
//                 disabled={!gameState.selectedCell || gameState.isComplete}
//               >
//                 Clear
//               </button>
...
//             <div className="bg-gradient-to-br from-emerald-500/20 via-teal-500/20 to-cyan-500/20 backdrop-blur-sm border-2 border-emerald-400/50 text-white p-8 rounded-3xl shadow-2xl max-w-md mx-auto animate-pulse">
...
//                   Congratulations!
//                 </h2>
//                 <p className="text-xl mb-4 text-emerald-300">Puzzle Completed!</p>
//                 <div className="bg-slate-900/50 p-4 rounded-xl mb-4">
//                   <p className="font-mono text-2xl text-cyan-400">Time: {formatTime(timer)}</p>
//                 </div>
//                 {timer === minTime && minTime > 0 && (
//                   <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 p-3 rounded-xl">
//                     <p className="text-yellow-300 font-bold text-lg">🏆 New Best Time!</p>
//                   </div>
//                 )}
//               </div>
//             </div>
...
//         <div className="text-center">
//           <div className="bg-gradient-to-br from-slate-800/30 via-slate-900/40 to-black/30 p-6 rounded-2xl shadow-xl border border-emerald-500/10 max-w-2xl mx-auto">
//             <h4 className="text-lg font-semibold text-emerald-400 mb-3">How to Play</h4>
...
const SudokuGame = () => {
  ...
  const getCellClasses = (row, col) => {
    let classes = 'w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 flex items-center justify-center text-base sm:text-lg md:text-xl font-bold cursor-pointer transition-all duration-200 select-none ';
    
    // Original puzzle cells (read-only)
    if (gameState.originalPuzzle[row][col] !== 0) {
      classes += 'bg-gradient-to-br from-slate-700/90 via-slate-800/95 to-slate-900 text-emerald-300 ';
    } else {
      classes += 'bg-gradient-to-br from-slate-800/70 via-slate-900/80 to-black/90 text-white hover:from-emerald-900/30 hover:via-teal-900/30 hover:to-cyan-900/30 hover:scale-105 ';
    }
    
    // Selected cell with glowing effect
    if (gameState.selectedCell && gameState.selectedCell[0] === row && gameState.selectedCell[1] === col) {
      classes += 'ring-2 ring-emerald-400 shadow-emerald-400/50 shadow-lg bg-gradient-to-br from-emerald-800/40 via-teal-800/40 to-cyan-800/40 scale-105 z-10 ';
    }
    
    // Error cells with pulsing effect
    if (gameState.errors[row][col]) {
      classes += 'text-red-300 bg-gradient-to-br from-red-900/50 via-red-800/60 to-red-700/50 ring-1 ring-red-400/50 animate-pulse ';
    }
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex justify-center items-center gap-6 mb-8">
          <div className="bg-gradient-to-br from-slate-800/80 via-slate-900/90 to-black/80 p-4 sm:p-6 rounded-xl shadow-xl border border-emerald-500/30">
            <div className="text-xs sm:text-sm text-emerald-400 mb-2 font-semibold tracking-wider uppercase text-center">Current Time</div>
          ...
          {minTime > 0 && (
            <div className="bg-gradient-to-br from-slate-800/80 via-slate-900/90 to-black/80 p-4 sm:p-6 rounded-xl shadow-xl border border-yellow-500/30">
              <div className="text-xs sm:text-sm text-yellow-400 mb-2 font-semibold tracking-wider uppercase text-center">Best Time</div>
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-gradient-to-br from-slate-800/50 via-slate-900/60 to-black/50 p-4 sm:p-6 rounded-xl shadow-xl border border-emerald-500/20">
            <h3 className="text-base sm:text-lg font-semibold text-emerald-400 tracking-wide text-center mb-4">Select Difficulty</h3>
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-gradient-to-br from-slate-900/80 via-black/90 to-slate-900/80 p-4 sm:p-6 rounded-2xl shadow-2xl border-2 border-emerald-500/30">
            <div className="grid grid-cols-3 gap-2 bg-gradient-to-br from-emerald-500/10 via-teal-500/10 to-cyan-500/10 p-3 rounded-xl">
              {Array(3).fill().map((_, boxRow) => 
                Array(3).fill().map((_, boxCol) => (
                  <div key={`box-${boxRow}-${boxCol}`} className={getBoxClasses(boxRow, boxCol)}>
                    <div className="grid grid-cols-3 gap-0">
                      {Array(3).fill().map((_, cellRow) =>
                        Array(3).fill().map((_, cellCol) => {
                          ...
                          return (
                            ...
                            >
                              {gameState.currentPuzzle[row][col] !== 0 ? gameState.currentPuzzle[row][col] : ''}
                            </div>
                          );
                        })
                      )}
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-gradient-to-br from-slate-800/50 via-slate-900/60 to-black/50 p-4 sm:p-6 rounded-xl shadow-xl border border-emerald-500/20">
            <h3 className="text-base sm:text-lg font-semibold text-emerald-400 tracking-wide text-center mb-4">Number Input</h3>
          ...
          <div className="flex justify-center mb-8">
            <div className="bg-gradient-to-br from-emerald-500/20 via-teal-500/20 to-cyan-500/20 backdrop-blur-sm border border-emerald-400/50 p-6 sm:p-8 rounded-2xl shadow-2xl max-w-md mx-auto animate-pulse">
              <div className="text-center">
                ...
                <p className="text-lg sm:text-xl mb-4 text-emerald-300">Puzzle Completed!</p>
                <div className="bg-slate-900/50 p-4 rounded-xl mb-4">
                  <p className="font-mono text-xl sm:text-2xl text-cyan-400">Time: {formatTime(timer)}</p>
                </div>
                {timer === minTime && minTime > 0 && (
                  <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 p-3 rounded-xl">
                    <p className="text-yellow-300 font-bold text-base sm:text-lg">🏆 New Best Time!</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-br from-slate-800/30 via-slate-900/40 to-black/30 p-6 rounded-xl shadow-lg border border-emerald-500/10 max-w-2xl mx-auto">
            <h4 className="text-base sm:text-lg font-semibold text-emerald-400 mb-3">How to Play</h4>
