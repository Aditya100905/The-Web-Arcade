  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-2 sm:p-4">
      ...
      {isMobile && gameState === "playing" && (
        <div className="absolute top-full w-fit  mt-2 text-center left-1/2 transform -translate-x-1/2 text-xs text-slate-400 bg-slate-800/80 px-3 py-1 rounded-full backdrop-blur-sm border border-slate-600/50">
