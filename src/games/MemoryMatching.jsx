...
// import { Star, RotateCcw, Trophy, Clock, Target, Zap, Play, Pause } from 'lucide-react';
...
// const difficulties = {
//   easy: { pairs: 6, name: 'Easy', timeBonus: 1.5 },
//   medium: { pairs: 8, name: 'Medium', timeBonus: 1.2 },
//   hard: { pairs: 12, name: 'Hard', timeBonus: 1.0 }
// };
...
//   useEffect(() => {
//     const savedStats = JSON.parse(sessionStorage.getItem('memoryGameStats') || '{}');
...
//     sessionStorage.setItem('memoryGameStats', JSON.stringify(newStats));
...
//         totalTime: gameStats.totalTime + timer,
//         bestTime: !gameStats.bestTime || timer < gameStats.bestTime ? timer : gameStats.bestTime
//       };
//       saveStats(newStats);
//     }
//   }, [matchedCards.length, cards.length, stars, streak, timer, difficulty, bestScore, gameStats, saveStats]);
...
//   const getGridCols = () => {
//     const numPairs = difficulties[difficulty].pairs;
//     return numPairs === 6 ? 'grid-cols-3' : numPairs === 8 ? 'grid-cols-4' : 'grid-cols-4';
//   };
...
//           <h1 className="text-5xl font-bold mb-2 bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-transparent">
//             Memory Master
//           </h1>
//           <p className="text-gray-300 text-lg">Challenge your mind and match the cards!</p>
//         </div>

//         {/* Difficulty Selection */}
//         <div className="flex justify-center mb-6">
//           <div className="bg-gradient-to-r from-pink-500 via-rose-500 to-red-500 p-1 rounded-lg">
//             <div className="bg-slate-900 rounded-md p-2 flex space-x-2">
...
//           <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg px-4 py-2 flex items-center space-x-2">
...
//           <button
//             onClick={resetGame}
//             className="bg-gradient-to-r from-pink-500 via-rose-500 to-red-500 hover:from-pink-600 hover:via-rose-600 hover:to-red-600 px-4 py-2 rounded-lg font-medium transition-all flex items-center space-x-2"
//           >
...
//             <button
//               onClick={togglePause}
//               className="bg-slate-700 hover:bg-slate-600 px-4 py-2 rounded-lg font-medium transition-all flex items-center space-x-2"
//             >
...
//             className="bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 disabled:cursor-not-allowed px-4 py-2 rounded-lg font-medium transition-all"
//           >
//             Hint
//           </button>
//         </div>
...
//         {/* Game Board */}
//         <div className="flex justify-center mb-6">
//           <div className="bg-gradient-to-br from-pink-500 via-rose-500 to-red-500 p-6 rounded-2xl shadow-2xl">
...
//                   <div
//                     key={index}
//                     className={`card h-20 w-20 rounded-xl flex items-center justify-center text-2xl cursor-pointer transition-all duration-300 transform hover:scale-105 ${
//                       isFlipped || isHinted
//                         ? isMatched 
...
//                     } ${isHinted ? 'ring-4 ring-yellow-400 ring-opacity-75' : ''} ${
...
//         {/* Game Statistics */}
//         <div className="max-w-md mx-auto bg-slate-800/50 backdrop-blur-sm rounded-lg p-4">
//           <h3 className="text-lg font-semibold mb-3 text-center">Game Statistics</h3>
...
//                 {gameStats.bestTime ? formatTime(gameStats.bestTime) : 'N/A'}
//               </div>
//             </div>
//             <div className="text-center">
//               <div className="text-gray-400">Best Score</div>
//               <div className="font-semibold">{bestScore || 'N/A'}</div>
//             </div>
//           </div>
//         </div>
...
//               <button
//                 onClick={togglePause}
//                 className="bg-gradient-to-r from-pink-500 via-rose-500 to-red-500 hover:from-pink-600 hover:via-rose-600 hover:to-red-600 px-6 py-3 rounded-lg font-semibold transition-all flex items-center space-x-2 mx-auto"
//               >
...
//             <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-2xl text-center max-w-md mx-4 border border-pink-500/30">
...
//                     Score: {Math.round((stars * 1000 + streak * 100) * difficulties[difficulty].timeBonus / Math.max(1, timer / 10))}
//                   </p>
//                 )}
//               </div>
//               <button
//                 onClick={resetGame}
//                 className="bg-gradient-to-r from-pink-500 via-rose-500 to-red-500 hover:from-pink-600 hover:via-rose-600 hover:to-red-600 px-8 py-3 rounded-lg font-semibold transition-all text-lg"
//               >
//                 Play Again
//               </button>
//             </div>
